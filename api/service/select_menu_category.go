...
func ProcessSelectMenuCategory(bot *linebot.Client, events []*linebot.Event, lineUserMsg repository.LineUserMsg, store repository.ChatSessionRepository) error {
